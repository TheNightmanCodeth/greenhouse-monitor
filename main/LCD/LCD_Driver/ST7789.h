...
void BK_Init();                             // Initialize the LCD backlight, which has been called in the LCD_Init function, ignore it                                                         
...
void LCD_Init();                     // Call this function to initialize the screen (must be called in the main function) !!!!!