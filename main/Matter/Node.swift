...
struct MatterTemperatureSensor: MatterConcreteEndpoint {
    ...
    init(_ node: RootNode, configuration: esp_matter.endpoint.temperature_sensor.config) {
...
struct MatterHumiditySensor: MatterConcreteEndpoint {
    static var deviceTypeId: UInt32 {
    ...
    init(_ node: RootNode, configuration: esp_matter.endpoint.humidity_sensor.config) {
        var config = configuration
