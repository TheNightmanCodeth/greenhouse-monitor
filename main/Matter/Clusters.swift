...
struct ClusterID<Cluster: MatterCluster>: RawRepresentable {
  ...
  static var relativeHumidityMeasurement: ClusterID<RelativeHumidityMeasurement> {
...
struct TemperatureMeasurement: MatterConcreteCluster {
    ...
    struct AttributeID<Attribute: MatterAttribute>: MatterAttributeID {
        var rawValue: UInt32
        static var state: AttributeID<CurrentTemperature> { .init(rawValue: 0x0000_0000) }
    }
    ...
    var state: CurrentTemperature { attribute(.state) }
}
...
struct RelativeHumidityMeasurement: MatterConcreteCluster {
    ...
    struct AttributeID<Attribute: MatterAttribute>: MatterAttributeID {
        var rawValue: UInt32
        static var state: AttributeID<CurrentRelativeHumidity> { .init(rawValue: 0x0000_0000) }
    }
    ...
    var state: CurrentRelativeHumidity { attribute(.state) }
}